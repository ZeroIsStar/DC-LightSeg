...
# Improved DeepLabV3+ model for landslide identification in high-resolution remote sensing images after earthquakes 2024
...
class AttentionDeeplabV3plus(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        # Encoder编码部分
        resnet = timm.create_model("tv_resnet50", pretrained=False, features_only=True, in_chans=3, output_stride=8)
...
if __name__ == "__main__":
    ...
    # print(a(x).shape)
    model =AttentionDeeplabV3plus(2).cuda()
